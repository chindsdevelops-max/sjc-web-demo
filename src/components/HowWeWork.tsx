          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="lg:col-span-7 relative bg-slate-900 aspect-video group">
              ...
              {!isPlaying && (
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-accent-500 flex items-center justify-center text-white shadow-glow-accent scale-95 hover:scale-105 transition-transform duration-200">
